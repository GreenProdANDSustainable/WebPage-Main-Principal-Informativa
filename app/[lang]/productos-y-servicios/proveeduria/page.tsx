        ...
        <div className="min-h-screen bg-slate-50 py-24">
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-16 border-b border-slate-200 pb-8">
                    ...
                    <h1 className="font-serif text-4xl md:text-5xl font-bold text-slate-900 mb-6">{d.proveeduria}</h1>
                    <p className="text-xl text-slate-600 leading-relaxed">{d.proveeduria_desc}</p>
                </div>
