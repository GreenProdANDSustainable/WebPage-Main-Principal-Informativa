...
/**
 * Once láminas de alga repartidas a lo ancho del recuadro (viewBox 0 0 200
 * 100): siete anchas y cuatro finas intercaladas, para que se lea como un
 * manojo tupido y no como hojas sueltas. `preserveAspectRatio="none"` las
