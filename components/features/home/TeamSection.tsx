  ...
  return (
    <section id="equipo" className="bg-ink relative overflow-hidden">
      <div className="relative aspect-[4/3] w-full sm:aspect-[16/9] lg:aspect-[21/9]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end px-4 pb-14 text-center sm:pb-20">
          ...
          <Reveal preset="growUp" delay={0.1}>
            <h2 className="font-display text-paper max-w-3xl text-3xl font-semibold tracking-tight md:text-5xl">
              {d.title}
            </h2>
          </Reveal>
          <Reveal preset="growUp" delay={0.2}>
            <p className="text-husk/80 mt-4 max-w-xl text-base md:text-lg">{d.subtitle}</p>
          </Reveal>
        </div>
      </div>
    </section>
